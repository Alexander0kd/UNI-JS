    ...
    function triangle(val1, type1, val2, type2) {
        ...
        if (type1 === "adjacent angle" && (val1 >= 90 || val1 <= 0.000000001) || type2 === "adjacent angle" && (val2 >= 90 || val2 <= 0.000000001)) {
            console.log("Кути повинні бути гострими (меншими за 90 градусів і не нульовим).");
            return "failed";
        }

        if (type1 === "opposite angle" && (val1 >= 90 || val1 <= 0.000000001) || type2 === "opposite angle" && (val2 >= 90 || val2 <= 0.000000001)) {
            console.log("Кути повинні бути гострими (меншими за 90 градусів і не нульовим).");
            return "failed";
        }

        if (type1 === "angle" && (val1 >= 90 || val1 <= 0.000000001) || type2 === "angle" && (val2 >= 90 || val2 <= 0.000000001)) {
            console.log("Кути повинні бути гострими (меншими за 90 градусів і не нульовим).");
            return "failed";
        }
